...
<body>
    ...
    <div class="container">
        ...
        <div class='row'>
            ...
            <div class="col">
                <form action="create.php?id_mobil=<?= $data_mobil['id_mobil']?>" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                        <b><label class="form-label">Nama Mobil</label></b>
                        <input type="text" class="form-control" name="nama" value="<?= $data_mobil['nama_mobil']?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="merk" value="<?= $data_mobil['merk_mobil']?>">
                    </div>
                    <div class="mb-3">
                        <b><label class="form-label">Tanggal Beli</label></b>
                        <input type="date" class="form-control" name="tanggal" value="<?= $data_mobil['tanggal_beli']?>">
                    </div>
                    <div class="mb-3">
                        <b><label class="form-label">Deskripsi</label></b>
                        <textarea class="form-control" name="deskripsi"><?= $data_mobil['deskripsi']?></textarea>
                    </div>
                    <div class="mb-3">
